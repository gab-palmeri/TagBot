...
export interface ITagRepository {
  ...
  renameTag(
    ...
    oldTagName: string,
    newTagName: string
  ): Promise<Result<null, "NOT_FOUND" | "ALREADY_EXISTS" | "DB_ERROR">>;
  ...
  getSubscribersByTag(
    tagName: string,
    groupId: string
  ): Promise<Result<SubscriberDTO[], "NOT_FOUND" | "NO_CONTENT" | "DB_ERROR">>;
...
export interface ITagService {
  ...
  getTagSubscribers(
    tagName: string,
    groupId: string
  ): Promise<Result<SubscriberDTO[], "NOT_FOUND" | "NO_CONTENT" | "INTERNAL_ERROR">>;

  getTagsByGroup(
    groupId: string
  ): Promise<Result<{
    mainTags: TagDTO[];
    secondaryTags: TagDTO[] | null;
